    ...
    topics: [
      {
        ...
        check: {
          ...
          options: [
            "Memorise each company's reported questions separately",
            "Learn the recurring problem set well, since the same twenty-five to thirty questions circulate across all of them",
            "Focus only on coding rounds",
            "Prepare only for the largest company",
          ],
          correctIndex: 1,
      ...
      },
      {
        ...
        check: {
          ...
          options: [
            "Reading more design write-ups",
            "Redoing a design you know with a changed constraint, out loud and timed",
            "Memorising database benchmarks",
            "Drawing neater diagrams",
          ],
          correctIndex: 1,
