    ...
    topics: [
      {
        ...
        check: {
          ...
          options: [
            "None — the ORM parameterises everything",
            "Injection through the ORDER BY clause, which cannot be parameterised as a value and needs an allowlist of column names",
            "Only a performance problem",
            "None, provided the input is escaped for quotes",
          ],
          correctIndex: 1,
      ...
      },
      {
        ...
        check: {
          ...
          options: [
            "In the interpolated text itself",
            "Nowhere — React is immune",
            "If that field is used as a link href, since javascript: URLs are not escaped by interpolation",
            "Only in server-rendered pages",
          ],
          correctIndex: 2,
      ...
      },
      {
        ...
        check: {
          ...
          options: [
            "Yes, always",
            "Not for classic CSRF — the browser does not attach that header to a cross-site request",
            "Only for GET requests",
            "Only if the API is on a different domain",
          ],
          correctIndex: 1,
      ...
      },
      {
        ...
        check: {
          ...
          options: [
            "Auditing the source of every dependency",
            "Pinning versions and never updating",
            "Fewer dependencies, a lockfile, prompt updates, and CI tokens scoped to the minimum",
            "Vendoring everything into the repository",
          ],
          correctIndex: 2,
    ...
    topics: [
      {
        ...
        check: {
          ...
          options: [
            "Yes, transactions must be repeatable",
            "No — non-repeatable reads are permitted at that level; use repeatable read if you need stability",
            "Only if the rows were deleted",
            "Yes, unless the table is unindexed",
          ],
          correctIndex: 1,
      ...
      },
      {
        ...
        check: {
          ...
          options: [
            "Missing indexes",
            "A long-running or idle-in-transaction session holding back cleanup of old row versions",
      ...
      },
      {
        ...
        check: {
          ...
          options: [
            "A lost update",
            "A dirty read",
            "Write skew — the constraint spans rows, and neither transaction wrote the row the other read",
            "A deadlock that resolved incorrectly",
          ],
          correctIndex: 2,
      ...
      },
      {
        ...
        check: {
          ...
          options: [
            "It is faster",
            "It removes the window where the commit succeeds and the publish does not, since both are one transaction",
            "It guarantees exactly-once delivery",
            "It avoids needing a message broker",
          ],
          correctIndex: 1,
    ...
    topics: [
      ...
      },
      {
        ...
        check: {
          ...
          options: [
            ...
            "Latency versus consistency — the E and L of PACELC",
            "Durability versus throughput",
            "There is no tradeoff without a partition",
          ],
          correctIndex: 1,
      ...
      },
      {
        ...
        check: {
          ...
          options: [
            ...
            "A bounded, known blast radius — one failure affects one cell's users rather than all of them",
      ...
      },
      {
        ...
        check: {
          ...
          options: [
            "About 100ms — the calls are parallel",
            "Most requests wait on at least one slow call, so 100ms becomes typical rather than rare",
            "10 seconds, since latency sums",
            "Unchanged, because p99 is rare",
          ],
          correctIndex: 1,
